...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <div class="container">
            ...
            <div class="row">
               <%-- <div class="col-2 ">
                    <asp:Label ID="Label3" runat="server" Text="Middle Name:" Visible="false" CssClass="boldText"></asp:Label>
                </div>
                <div class="col-4 ">
                    <asp:TextBox ID="txtMiddleName" runat="server" CssClass="textBox" Visible="false" Text=""></asp:TextBox>
                </div>--%>
                <div class="col-2">
                    <asp:Label ID="Label5" runat="server" Text="Family Name:" Visible="true" CssClass="boldText"></asp:Label>
                </div>
                <div class="col-4 ">
                    ...
                    <asp:RequiredFieldValidator ID="rfvLastName" runat="server" CssClass="validation"
                        ErrorMessage="Please enter family name" ControlToValidate="txtLastName" ValidationGroup="VPersonalInformation" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
            ...
            <div class="row">
                <div class="col-2">
                    <asp:Label ID="Label17" runat="server" Text="Address: " CssClass="boldText"></asp:Label></div>
                <div class="col-10">
                    <asp:TextBox ID="txtAddress" runat="server" MaxLength="240" CssClass="textBox90percent" Text=""></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvAddres" runat="server" CssClass="validation"
                        ErrorMessage="Please enter address" ControlToValidate="txtAddress" ValidationGroup="VPersonalInformation" Display="Dynamic"></asp:RequiredFieldValidator>

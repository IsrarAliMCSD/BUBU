...
<div class="container">
    ...
    <div class="row">
        <div class="col-4">
            <asp:Label ID="Label9" runat="server" Text="Qualification  Category:"></asp:Label>
            ...
            <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator1" Display="Dynamic" CssClass="validation"
                ValidationGroup="VGInsertQualification" runat="server" ControlToValidate="ddlfQualificationCategory"

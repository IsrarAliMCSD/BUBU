...
<%@ Register Src="~/Forms/UserControls/PersonalInformationForCVControl.ascx" TagPrefix="uc1" TagName="PersonalInformationForCVControl" %>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <uc1:PersonalInformationForCVControl runat="server" ID="PersonalInformationForCVControl1" />
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-8">
                <asp:Label ID="lblSchoolEducation" runat="server" CssClass="mainHeading" Text="SCHOOL EDUCTION"></asp:Label>
            </div>
            <div class="col-4">
        ...
        <div class="row">
            <div class="col-8">
                <asp:Label ID="Label5" runat="server" CssClass="mainHeading" Text="REFERENCE"></asp:Label>
            </div>
            <div class="col-4">
        ...
        <asp:Repeater ID="rptruserreference" runat="server">
            <ItemTemplate>
                <div class="row">
                    <div class="col-4">
                        <asp:Label ID="lblReferenceName" runat="server" CssClass=""
                            Text='<%# Eval("Reference.ReferenceName") %>'></asp:Label>
                    </div>
                    <div class="col-8">
                        <asp:Label ID="Label1" runat="server" CssClass=""
                            Text='<%#  Eval("ReferenceName") %>'></asp:Label>,  &nbsp;
        ...
        <div class="row">
            <div class="col-12">
                <asp:Label ID="lblCommencement" runat="server" CssClass="" Text=""></asp:Label>
            </div>
        </div>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PersonalInformationForCVControl.ascx.cs" Inherits="Bubu_WebApp.Forms.UserControls.PersonalInformationForCVControl" %>
<div>
    <div class="container">
        <div class="row">
            <%--<div class="col-12 ">
        ...
        <div class="row">
            ...
            <div class="col-4">
             ...
             <div class="col-4">
                <asp:Label ID="lblMarried" runat="server" Text=""></asp:Label>
            </div>

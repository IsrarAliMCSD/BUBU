...
<asp:Label ID="lblIsParticularUser" CssClass="boldText" runat="server" ClientIDMode="Static" Style="display: none" Text=""></asp:Label>
<div class="row">
    <div class="col-12 ">
...
<div class="row">
    <div class="col-3">
        <asp:Label ID="Label7" CssClass="boldText" runat="server" Text="Age: "></asp:Label>
    </div>
    <div class="col-9">
        <asp:DropDownList ID="ddlAge" CssClass="ddlWidth260 ddl" runat="server"></asp:DropDownList>
    </div>
</div>
<div class="row">
    <div class="col-3">
    ...
    <div class="col-12">
        <asp:GridView ID="gvCandidateSearch" ShowHeader="false" GridLines="Horizontal" runat="server" AutoGenerateColumns="false" Width="100%" EmptyDataText="No Record Founds." OnRowCommand="gvCandidateSearch_RowCommand">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:Label ID="Label19" runat="server" CssClass="boldText" Text="Match"></asp:Label><br />
                        <asp:Label ID="Label110" runat="server" CssClass="boldText" Text='<%# Eval("CVMatch")+"%" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lbtnContact" runat="server" CommandName="SENDMESSAGE" CommandArgument='<%# Bind("User.Userid") %>' CausesValidation="false" Text="Contact Candidate" ToolTip="Contact Candidate" />

                        <br />
                        <asp:LinkButton ID="lbtnDownloadFile" runat="server" Visible="false"
...
<script>
    $(document).ready(function () {
        var id = $("#lblIsParticularUser").text();
        if (id != "" && id != undefined && id != null) {
            $("#EmployeerAboutUs").hide();
            $("#EmployeerVacancyMgmt").hide();
            $("#EmployerNEWSMgmt").hide();

            $("#CVMGMT").removeClass("hide").attr("idx", id);
            $("#CERTIFICATEMGMT").removeClass("hide").attr("idx", id);

            // onclick="Redirect('EmployerNEWSMgmt.aspx')">

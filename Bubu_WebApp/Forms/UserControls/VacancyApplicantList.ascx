        ...
        <div class="col-12">
            ...
            <asp:GridView ID="gvApplicant" runat="server" AutoGenerateColumns="false" Width="100%" EmptyDataText="No vacancy application exists." GridLines="Horizontal" OnRowCommand="gvApplicant_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Label ID="Label99" runat="server" CssClass="boldText" Text="Match"></asp:Label><br />
                            <asp:Label ID="Label10" runat="server" CssClass="boldText" Text='<%# Eval("CVMatch")+"%" %>'></asp:Label>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnContact" runat="server" CommandName="SENDMESSAGE" CausesValidation="false" Text="Contact" ToolTip="ContactCandidate" />
                            ...
                            <br />
                            <%--<asp:LinkButton ID="lbtnDownloadFile" runat="server" ClientIDMode="Static"

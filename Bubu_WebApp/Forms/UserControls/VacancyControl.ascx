...
<div class="container">
    ...
    <div class="row">
        <div class="col-4">
            <asp:Label ID="Label9" runat="server" CssClass="boldText"
                Text="URL: "></asp:Label>
        </div>
        <div class="col-8">
            <asp:TextBox ID="txtURL" runat="server" TextMode="SingleLine" ClientIDMode="Static"
                CssClass="width450"></asp:TextBox>
            <img id="img_loadImage" src="../../Images/url.png" class="widthHeight50 pointer" onclick="loadURL(this)" fetchurlid="txtURL" /><br />
        </div>
    ...
    <div class="row">
        <div class="col-4">
            <asp:Label ID="Label19" runat="server" CssClass="boldText" Text="Qualification  Category:"></asp:Label>
        </div>
        <div class="col-8">
            ...
            <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator3" Display="Dynamic" CssClass="validation"
                ValidationGroup="VGVacancy" runat="server" ControlToValidate="ddlfQualificationCategory"
    ...
    <div class="row">
        <div class="col-4">
            <asp:Label ID="Label10" runat="server" CssClass="boldText" Text="Education:"></asp:Label><br />
        </div>
        <div class="col-8">
            ...
            <asp:RequiredFieldValidator InitialValue="-1" ID="rfvQualification" Display="Dynamic" CssClass="validation"
                ValidationGroup="VGVacancy" runat="server" ControlToValidate="ddlfQualification"

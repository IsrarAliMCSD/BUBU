        ...
        <Columns>
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    ...
                    <%--<asp:Label ID="Label6" runat="server" Text='<%# Bind("CompanyInformation.JoFunction") %>'></asp:Label>--%>
                    <br />
            ...
            <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnMoreInfos" runat="server" Text="More Infos" CausesValidation="false"
                        ToolTip='<%# Bind("CompanyInformation.CompanyAddress")%>'

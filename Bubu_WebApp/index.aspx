        ...
        <div>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-3   text-center pointer backgroundYellow" style="height: 200px;" onclick="Redirect('Login.aspx?mode=EMPLOYEE')">
                        <br />
                        <br />  <br />  <br />
                        Arbeitnehmer
                        <br />  <br />  <br />
                    ...
                    <div class="col-2"></div>
                    <div class="col-3 text-center pointer  backgroundYellow" style="height: 200px;" onclick="Redirect('Login.aspx?mode=EMPLOYER')">
                        <br />  <br />  <br />
                        <br />
                        Untemehmen<br />
                       <br />  <br />  <br />
